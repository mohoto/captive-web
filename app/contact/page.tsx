...
export const metadata: Metadata = {
  ...
  description:
    "Contactez Captive Web pour votre projet de site web. Devis gratuit et personnalisé. Créateur de sites vitrine, e-commerce et applications web.",
  robots: {
    index: true,
    follow: false,
  },
  ...
  keywords:
    "contact captive web, devis site web cachan, agence web 94230, création site internet contact",
  openGraph: {
    title: "Contact Captive Web | Devis Gratuit",
    description:
      "Contactez notre agence web à Cachan pour votre projet. Devis gratuit sous 24h.",
